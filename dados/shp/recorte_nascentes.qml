...
<qgis simplifyMaxScale="1" readOnly="0" simplifyDrawingHints="0" simplifyDrawingTol="1" maxScale="0" hasScaleBasedVisibilityFlag="0" styleCategories="AllStyleCategories" minScale="100000000" simplifyLocal="1" labelsEnabled="0" simplifyAlgorithm="0" version="3.16.0-Hannover">
  <flags>
    ...
    <symbols>
      <symbol force_rhr="0" alpha="1" name="0" type="marker" clip_to_extent="1">
        <layer enabled="1" class="SimpleMarker" pass="0" locked="0">
          ...
          <prop v="255,249,249,255" k="outline_color"/>
  ...
  <referencedLayers/>
  <fieldConfiguration>
    <field name="idf" configurationFlags="None">
    ...
    <field name="tema" configurationFlags="None">
      <editWidget type="TextEdit">
        <config>
          <Option/>
        </config>
  ...
  <aliases>
    <alias field="idf" index="0" name=""/>
    <alias field="tema" index="1" name=""/>
    <alias field="cod_ibge_m" index="2" name=""/>
  </aliases>
  <defaults>
    <default applyOnUpdate="0" field="idf" expression=""/>
    <default applyOnUpdate="0" field="tema" expression=""/>
    <default applyOnUpdate="0" field="cod_ibge_m" expression=""/>
  </defaults>
  <constraints>
    <constraint notnull_strength="0" exp_strength="0" field="idf" unique_strength="0" constraints="0"/>
    <constraint notnull_strength="0" exp_strength="0" field="tema" unique_strength="0" constraints="0"/>
    <constraint notnull_strength="0" exp_strength="0" field="cod_ibge_m" unique_strength="0" constraints="0"/>
  </constraints>
  <constraintExpressions>
    <constraint desc="" exp="" field="idf"/>
    <constraint desc="" exp="" field="tema"/>
  ...
  <attributetableconfig sortExpression="" actionWidgetStyle="dropDown" sortOrder="0">
    <columns>
      <column name="idf" width="-1" hidden="0" type="field"/>
      <column name="tema" width="-1" hidden="0" type="field"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <editable>
    ...
    <field name="idf" editable="1"/>
    <field name="tema" editable="1"/>
  </editable>
  <labelOnTop>
    <field labelOnTop="0" name="cod_ibge_m"/>
    <field labelOnTop="0" name="idf"/>
    <field labelOnTop="0" name="tema"/>
  </labelOnTop>
  <dataDefinedFieldProperties/>
  <widgets/>
  <previewExpression>"idf"</previewExpression>
  <mapTip></mapTip>
